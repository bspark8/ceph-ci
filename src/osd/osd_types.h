...
public:
  ...
  double get_qos_res() const { return qos_res; }
  double get_qos_wgt() const { return qos_wgt; }
  double get_qos_lim() const { return qos_lim; }

  void set_qos_res(double r) { qos_res = r; }
  void set_qos_wgt(double w) { qos_wgt = w; }
  void set_qos_lim(double l) { qos_lim = l; }
